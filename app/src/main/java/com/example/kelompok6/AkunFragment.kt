...
class AkunFragment : Fragment(R.layout.fragment_akun) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        tvNamaAkun = view.findViewById(R.id.et_namaakun)
        tvUsername = view.findViewById(R.id.et_username)
        tvNoHp = view.findViewById(R.id.et_nohp)
        ...
        if (user != null) {
            ...
            databaseReference.child(userId).addListenerForSingleValueEvent(object : ValueEventListener {
                ...
                override fun onCancelled(error: DatabaseError) {
                    // Handle error
                    Toast.makeText(requireContext(), "Gagal mengambil informasi akun", Toast.LENGTH_SHORT).show()
                }
            })
        }
    }
        ...
        if (user != null) {
            ...
            databaseReference.child(userId).updateChildren(userInfo)
                .addOnSuccessListener {
                    Toast.makeText(requireContext(), "Informasi akun berhasil disimpan", Toast.LENGTH_SHORT).show()
                }
                .addOnFailureListener {
                    Toast.makeText(requireContext(), "Gagal menyimpan informasi akun", Toast.LENGTH_SHORT).show()
                }
        }
    }
